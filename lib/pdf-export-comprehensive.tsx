    ...
    <div class="page cover-page">
        ...
        <div class="cover-info">
            <div class="cover-info-item">
                <span>${language === "ar" ? "📊 تقرير التسعير مقدم إلى:" : "📊 Pricing Report Submitted to:"}</span>
                <span>${data.companyInfo?.companyName || (language === "ar" ? "غير محدد" : "Not specified")}</span>
            </div>
            <div class="cover-info-item">
            ...
            <p>${language === "ar" ? "تم توزيع التكاليف الثابتة" : "Fixed costs were allocated"} ${
              data.costAllocation?.method === "equal"
                ...
                : data.costAllocation?.method === "volume"
                  ? (
                      language === "ar"
                        ? "حسب حجم المبيعات المتوقع لكل منتج"
                        : "based on expected sales volume for each product"
                    )
                  : data.costAllocation?.method === "revenue"
                    ? language === "ar"
                      ? "حسب الإيرادات المتوقعة لكل منتج"
                      : "based on expected revenue for each product"
                    : language === "ar"
                      ? "يدوياً حسب المعايير المحددة"
                      : "manually based on specified criteria"
            }</p>
        </div>
    </div>
                ...
                <div class="methodology-item">
                    ...
                    <p>
                        ${
                          data.costAllocation?.method === "equal"
                            ? language === "ar"
                              ? "تم توزيع التكاليف الثابتة بالتساوي بين جميع المنتجات"
                              : "Fixed costs were allocated equally among all products"
                            : data.costAllocation?.method === "volume"
                              ? (
                                  language === "ar"
                                    ? "تم توزيع التكاليف الثابتة حسب حجم المبيعات المتوقع لكل منتج"
                                    : "Fixed costs were allocated based on expected sales volume for each product"
                                )
                              : data.costAllocation?.method === "revenue"
                                ? language === "ar"
                                  ? "تم توزيع التكاليف الثابتة حسب الإيرادات المتوقعة لكل منتج"
                                  : "Fixed costs were allocated based on expected revenue for each product"
                                : language === "ar"
                                  ? "تم توزيع التكاليف الثابتة يدوياً حسب المعايير المحددة"
                                  : "Fixed costs were allocated manually based on specified criteria"
                        }
                    </p>
                </div>
            </div>
