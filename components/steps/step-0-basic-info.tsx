...
export function Step0BasicInfo({ data, onDataChange, errors, language }: Step0Props) {
  const countries = [
  ...
  const companySizes = [
    {
      id: "freelancer",
      name: t(language, "basicInfo.freelancer"),
      desc: t(language, "basicInfo.freelancerDesc"),
    },
    {
      id: "startup",
      name: t(language, "basicInfo.startup"),
      desc: t(language, "basicInfo.startupDesc"),
    },
    {
      id: "sme",
  ...
  const showSectorAndProducts =
    data.companyInfo?.companySize && ["sme", "enterprise"].includes(data.companyInfo.companySize)

  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-[#0f172a] mb-6">{t(language, "basicInfo.title")}</h2>

        {/* Personal Information */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-[#0f172a] mb-4">{t(language, "basicInfo.personalInfo")}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-[#0f172a] mb-2">
                {t(language, "basicInfo.fullName")} *
              </label>
              <input
                type="text"
                ...
                placeholder={t(language, "basicInfo.fullNamePlaceholder")}
                required
                aria-required="true"
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder={t(language, "basicInfo.phonePlaceholder")}
                required
                aria-required="true"
              />
          ...
          {language === "ar" && (
            <CollapsibleHint sectionName="personal-info">
              <div className="text-sm text-[#64748b] space-y-2">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <p>علشان نقدر نحسبلك التسعير المناسب لبلدك وظروف شغلك</p>
                  </div>
                </div>
              </div>
            </CollapsibleHint>
        ...
        {/* Company Information */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-[#0f172a] mb-4">{t(language, "basicInfo.companyInfo")}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <label className="block text-sm font-medium text-[#0f172a] mb-2">
                {t(language, "basicInfo.companyName")} *
              </label>
              <input
                type="text"
                ...
                placeholder={t(language, "basicInfo.companyNamePlaceholder")}
                required
                aria-required="true"
              />
            ...
            <div>
              <label className="block text-sm font-medium text-[#0f172a] mb-2">
                {t(language, "basicInfo.foundedYear")}
              </label>
              <input
                type="number"
                min="1900"
          ...
          <div>
            <label className="block text-sm font-medium text-[#0f172a] mb-3">
              {t(language, "basicInfo.companySize")} *
            </label>
            <div
              className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 ${errors.companySize ? "border border-[#dc2626] rounded-lg p-2" : ""}`}
              role="radiogroup"
          ...
          {language === "ar" && (
            <CollapsibleHint sectionName="company-info">
              <div className="text-sm text-[#64748b] space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-base flex-shrink-0 mt-0.5">💼</span>
                  <div className="space-y-2">
                    <p className="font-medium text-[#475569]">معلومات الشركة أو البيزنس:</p>
                    <p>علشان نفهم حجم شغلك ونديلك نصايح مناسبة</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-base flex-shrink-0 mt-0.5">📊</span>
                  <div className="space-y-2">
                    ...
                    <p>اختار الوصف اللي أقرب لوضعك علشان نديلك الحسابات المناسبة لحجمك</p>
                  </div>
                </div>
              </div>
            </CollapsibleHint>
        ...
        {/* Setup - Only show if company type is selected and not freelancer or startup */}
        {showSectorAndProducts && (
          <div>
            <h3 className="text-lg font-semibold text-[#0f172a] mb-4">{t(language, "basicInfo.setup")}</h3>

            <div className="mb-6">
              <label className="block text-sm font-medium text-[#0f172a] mb-3">
                {t(language, "basicInfo.sector")} *
              </label>
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-[#0f172a] mb-3">
                {t(language, "basicInfo.numberOfProducts")} *
              </label>
              <div
              ...
              >
                ...
                >
                  <div className="text-center">
                    <div className="flex items-center justify-center mb-2">
                      <h4 className="font-semibold text-[#0f172a]">{t(language, "basicInfo.singleProduct")}</h4>
                      {data.productMode === "single" && <span className="ml-2 text-[#3b82f6]">✅</span>}
                    </div>
                    <p className="text-sm text-[#64748b]">{t(language, "basicInfo.singleProductDesc")}</p>
                  </div>
                </div>
                ...
                >
                  <div className="text-center">
                    <div className="flex items-center justify-center mb-2">
                      <h4 className="font-semibold text-[#0f172a]">{t(language, "basicInfo.multipleProducts")}</h4>
                      {data.productMode === "multi" && <span className="ml-2 text-[#3b82f6]">✅</span>}
                    </div>
                    <p className="text-sm text-[#64748b]">{t(language, "basicInfo.multipleProductsDesc")}</p>
                  </div>
                </div>
              </div>
            ...
            {language === "ar" && (
              <CollapsibleHint sectionName="setup-info">
                <div className="text-sm text-[#64748b] space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="text-base flex-shrink-0 mt-0.5">🏢</span>
                    <div className="space-y-2">
                      <p className="font-medium text-[#475569]">مجال الشغل:</p>
                      <p>اختار القطاع اللي بتشغل فيه علشان نديلك نصايح مخصوصة لمجالك ومعدلات الربح المناسبة</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-base flex-shrink-0 mt-0.5">📦</span>
                    <div className="space-y-2">
                      ...
                      <p>عندك منتج واحد بس ولا أكتر من منتج؟ ده هيغير طريقة حساب التكاليف والأرباح</p>
                    </div>
                  </div>
                </div>
              </CollapsibleHint>
        ...
        <div>
          <label className="block text-sm font-medium text-[#0f172a] mb-2">{t(language, "basicInfo.currency")} *</label>
          <select
            value={data.currency}
            ...
            aria-required="true"
          >
            <option value="">{t(language, "basicInfo.selectCurrency")}</option>
          ...
          {language === "ar" && (
            <CollapsibleHint sectionName="currency-info">
              <div className="text-sm text-[#64748b]">
                <div className="flex items-start gap-3">
                  <span className="text-base flex-shrink-0 mt-0.5">💰</span>
                  <div className="space-y-2">
                    <p className="font-medium text-[#475569]">العملة:</p>
                    <p>اختار العملة اللي بتحاسب بيها عملاءك علشان كل الحسابات تطلع بنفس العملة</p>
                  </div>
                </div>
              </div>
            </CollapsibleHint>
